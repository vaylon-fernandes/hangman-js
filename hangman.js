...
var wordlist = [
  ...
  {
    word: "LABOURER",
    hint: "Earn to survive",
  },
  {
    word: "WHITE LILY",
    hint: "Symbolizes purity",
  },
  {
    word: "COMPASSIONATE",
    hint: "Concerned towards others",
  },
  {
    word: "LAW ABIDING",
    hint: "Follower of responsibilities",
  },
  {
    word: "CUSTODIAN",
    hint: "Always there to help us",
  },
  {
    word: "PRUDENT",
    hint: "very much caring.",
  },
  {
    word: "SERINITY",
    hint: "Capacity to tolerate anything",
  },
  {
    word: "HOLY FAMILY",
    hint: "Ideal model of love",
  },
];
...
var Hangman = (function () {
  ...
  Hangman.prototype.reset = function () {
    ...
    this.showElementByIdWithContent(
      this.elId + "_hintbox",
      "<button onclick='Hangman.showHint(); return false'>HINT</button>"
    );
